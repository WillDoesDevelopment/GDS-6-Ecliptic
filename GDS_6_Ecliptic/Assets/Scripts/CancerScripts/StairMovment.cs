...
public class StairMovment : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawLine(new Vector3(transform.position.x, transform.position.y - 5f, zPosLock - 1.5f), new Vector3(transform.position.x, transform.position.y + 5f, zPosLock - 1.5f));
